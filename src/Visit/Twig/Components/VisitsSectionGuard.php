...
/**
 * Role gate for every visits-section live component. The /_components/
 ...
 * replaying a saved component payload could keep reading visit data.
 ...
 */
trait VisitsSectionGuard
{
    #[PreReRender]
    public function denyUnlessVisitsSection(): void
    {
        if (!$this->security->isGranted('ROLE_SECTION_VISITS')) {
            throw new AccessDeniedException('Visits section access required.');
        }
    }
}
